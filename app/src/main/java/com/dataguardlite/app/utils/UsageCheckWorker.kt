...
import com.dataguardlite.app.services.UsageMonitorService
...
class UsageCheckWorker(ctx: Context, params: WorkerParameters) : CoroutineWorker(ctx, params) {
    override suspend fun doWork(): Result {
        ...
        // Self-heal: if permission granted and service died, restart it
        if (PermissionUtils.hasUsageAccess(ctx)) {
